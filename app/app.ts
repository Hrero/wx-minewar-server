...
//创建服务器
const server = require("http").createServer(function serveIndex (req: any, res: any) {
  res.write(`
    <html>
    <head>
    <title>微信小游戏</title>
...
ws.on("connection", (ws: { send: (arg0: string) => void; on: (arg0: string, arg1: (e: any) => void) => void; }) => {
    console.log("已连接客户端");
    //发送消息给客户端
